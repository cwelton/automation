...
#     https://raw.githubusercontent.com/apache/incubator-quickstep/master/cyclic_dependency.py
#
#  This file has been modified to remove explicit dependencies on the quickstep project  
...
EXCLUDED_TOP_LEVEL_DIRS = ["build", "bin", "license"]
