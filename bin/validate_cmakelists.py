...
#      https://github.com/apache/incubator-quickstep/blob/master/validate_cmakelists.py
#
#   This file has been modified to work for generic projects running, notably to
#   remove quickstep specific dependencies.
...
EXCLUDED_TOP_LEVEL_DIRS = ["build", "bin"]
...
def main(cmakelists_to_process):
    ...
    for cmakelists_filename in cmakelists_to_process:
        print "validating " + cmakelists_filename
